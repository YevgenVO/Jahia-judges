            ...
            <div id="coordonnees">
                ...
                <ul style="list-style-type: none;">
                    ...
                    <li><label class="left">Email *</label><input name="email" type="email" id="email"
                                                                  value="${Email.string}"
                                                                  class="right"/></li>
                    <li><label class="left"></label><input name="AdditionalEmail" type="email" value="${AdditionalEmail[0].string}" class="right"/>
                    </li>
                    <li><label class="left"></label><input name="AdditionalEmail" type="email" value="${AdditionalEmail[1].string}" class="right"/>
                    </li>
                </ul>
